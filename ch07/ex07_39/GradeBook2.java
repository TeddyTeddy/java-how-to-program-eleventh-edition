...
public class GradeBook2 {
   ...
   // TODO: throw an exception if numStudents and/or numExams are negative
   public GradeBook2(String courseName, int numStudents, int numExams) {
      this.courseName = courseName; 
      this.grades = new int[numStudents][numExams];
      for(int student = 0; student < this.grades.length; ++student ) {
    	  Arrays.fill(this.grades[student], -1); // set each element of the new array to -1 to indicate that no grade has been entered for that element
      }
   }
   
   public void setGrade(int studentNo, int examNo, int grade) {
	   grades[studentNo-1][examNo-1] = grade;
   }
